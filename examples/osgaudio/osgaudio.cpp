...
osg::Node* createBase(const osg::Vec3& center,float radius)
{
    ...
    // [piptouque]: those two need to be osg::ref_ptr
    // to be properly handled by OSG when given to
    // the osg::Geometry object.
    ...
    // [piptouque]: That's how we set indices now, by using custom user's data.
    ...
    // osg::Geometry::BIND_PER_PRIMITIVE becomes (osg::Array::Binding)3 (not valid enum value)?
    // I think it's just a way to signal that the data is deprecated
